...
<div class="mdui-container-fluid">
	...
	<form action="" method="post">
		...
		<div class="mdui-textfield mdui-textfield-floating-label">
		   <i class="mdui-icon material-icons">&#xe41a;</i>
		   <?php if($redirect_uri == 'https://lab.toshiki.top/tools/oneindext'):?>
		   <label class="mdui-textfield-label">由于你的网站不是<b>http://localhost/</b>。将通过lab.toshiki.top/tools/oneindext进行中转</label>
		   <?php endif;?>
