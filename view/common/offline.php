...
<?php view::begin('content');?>
  ...
  <body>
    ...
    <script src="/assets/js/jquery.jsonrpc.js"></script>
    <script src="/assets/js/jquery.Storage.js"></script>
    <script src="/assets/js/jquery.base64.min.js"></script>
    <script src="/assets/js/mustache.js"></script>
    <script src="/assets/js/peerid.js"></script>
    <script src="/assets/js/aria2.js"></script>
    <script src="/assets/js/yaaw-1.1.js"></script>
  </body>
